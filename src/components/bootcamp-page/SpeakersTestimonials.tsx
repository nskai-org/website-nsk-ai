...
import { speakersTestimonials } from "./speakersTestimonialData";

const SpeakersTestimonials: React.FC = () => {
  return (
        ...
        {speakersTestimonials.map((t) => (
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-gray-500">{t.organization}</p>
            </div>
...
export default SpeakersTestimonials;
